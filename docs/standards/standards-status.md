...
|---|---|---|
| CareTrust JSON contracts and JSON Schema | **Implemented and tested** | Strict Pydantic models, deterministic Draft 2020-12 schema exports, validation tests, and synthetic JSON examples. These are CareTrust application contracts, not an external standard. |
